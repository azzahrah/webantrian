...
<html>
    <head>
        ...
        <script src="js/xlsx.core.min" type="text/javascript" charset="utf-8"></script>
        ...
        <script src="js/buffer-loader.js?v=1.0.4" type="text/javascript" charset="utf-8"></script>        
        <script src="js/forms.js?v=1.0.25" type="text/javascript" charset="utf-8"></script>
        <script src="js/app.js?v=1.0.29" type="text/javascript" charset="utf-8"></script>
