...
switch ($user_level) {
    case 'admin':
        ...
        break;
    case 'reseller':
        $where = isset($_GET['filter']['value']) ? " where reseller_id='$user_id' or id='$user_id' and real_name like '%" . $mysqli->real_escape_string($_GET['filter']['value']) . "%'" : "where reseller_id='$user_id' or id='$user_id'";        
        break;
    default:
