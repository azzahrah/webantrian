...
var form_pendaftaran = {
    ...
    "elements": [
        {
            view: "radio", name: "jenis_pendaftaran", label: "Jenis Pendaftaran", value: "baru", options: [{id: "baru", value: "Baru"}, {id: "perpanjangan", value: "Perpanjangan"}], labelWidth: 170
        },
        {
...
var form_antrian = {
    ...
    "elements": [
        {
            view: "text", name: "id", label: "ID", hidden: true, labelWidth: 120,fillspace:true
        },
        {
        ...
        {
            view: "text", name: "nomor", label: "Nomor Antrian", readonly: true, labelWidth: 120,fillspace:true
        },
        {
            view: "text", name: "nama", label: "Nama", readonly: true, labelWidth: 120,fillspace:true
        },
        {
            view: "text", name: "alamat", label: "Alamat", readonly: true, labelWidth: 120,fillspace:true
        },
        {
            margin: 10,
            cols: [
                {view: "button", label: "Hold", type: "danger", align: "center", width: 100, click: function () {
                        app.antrian.hold();
                    }},
                {view: "button", label: "Berikutnya", type: "form", align: "center", width: 100, click: function () {
                        app.antrian.load_next();
                    }
                },
                {view: "button", label: "Panggil", align: "center", width: 100, click: function () {
                        app.antrian.call();
                    }
                }
            ]
