...
util.create_info = function (v) {
    ...
    result += "<tr><td>User :</td><td>" + v.real_name + "</td></tr>"
            ...
            + "<tr><td>Position:</td><td>" + util.stringDivider(v.address, 40, "<br/>\n") + "</td></tr>"
            + "<tr><td>Lat/Lng:</td><td>" + v.lat + "," + v.lng + "</td></tr>"
...
util.formatAlarm = function (val, row) {
    var str = "N/A";
...
util.create_info_gps = function (v) {
    ...
    var html = "<table class='tbl_info'>" +
            "<tr><td>" + lang.license + "</td><td>:</td><td><a href='#' onClick='map.select_gps(" + v.id + ");'>" + nopol + "</a></td></tr>" +
            ...
            "<tr><td>" + lang.addr + "</td><td>:</td><td>" + util.stringDivider(v.poi + ',' + v.address, 30, "<br/>\n") + "</td></tr>" +
    ...
    html += "<tr><td>Jarak Tempuh</td><td>:</td><td><b style='color:#F00;'>" + parseInt(v.odo, 10) + " Km</b></td></tr>";
    if (parseInt(v.max_park, 10) > 0) {
    ...
    html += "<tr><td>" + lang.phone + "/" + lang.imei + "</td><td>:</td><td>" + v.phone + "/" + v.imei + "</td></tr>";
...
util.create_icon_object = function (img_icon) {
    try {
        var image = {
            url: 'icon/objects/' + img_icon + '?v=0.2',
            size: new google.maps.Size(40, 40),
...
util.format_status = function (obj) {
    console.log(obj);
    if (obj.status === "Unstart") {
